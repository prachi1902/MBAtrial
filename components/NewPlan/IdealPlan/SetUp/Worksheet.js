...
const Worksheet = () => {
  ...
  const getIMPValues = () => {
    const temp = [];
    Object.values(mediaPlanState.impMediaInflationValues).forEach((value) => {
  ...
  const getBVTValues = () => {
    const temp = {};
    Object.values(mediaPlanState.impBvtValues).forEach((map) => {
  ...
  const getNRValues = () => {
    const temp = {};
    Object.values(mediaPlanState.impNRHLValues).forEach((map) => {
  ...
  const getMacoValues = () => {
    const temp = {};
    Object.values(mediaPlanState.impMacoHLValues).forEach((map) => {
  ...
  return (
    <Workbook
      filename="Ideal Plan Adjustments.xlsx"
      element={
        <IconButton
          variant="gray"
          ml="1rem"
